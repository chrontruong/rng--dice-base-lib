...
public interface PowerUpGamePlayExtension extends Extension {
    default String getName() {
        return this.getClass().getName();
    }
    BasePlaySession playPowerUp(BasePlaySession basePlaySession, UserInfo userInfo, String commandId, int openCell,
