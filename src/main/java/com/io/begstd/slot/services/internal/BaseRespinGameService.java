...
public abstract class BaseRespinGameService extends BaseSpinService {
...
//        ISlotMachineConfig slotMachineConfigForFree = (ISlotMachineConfig) configMapper.get(SlotConfigMode.FREE);
