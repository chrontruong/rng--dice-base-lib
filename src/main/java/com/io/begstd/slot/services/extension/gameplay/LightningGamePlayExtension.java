...
public interface LightningGamePlayExtension extends Extension {
    default String getName() {
        return this.getClass().getName();
    }
    BasePlaySession playLightning(BasePlaySession basePlaySession, UserInfo userInfo, String commandId,
