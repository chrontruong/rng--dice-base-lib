...
import com.io.begstd.slot.services.internal.BaseRespinGameService;
...
public final class RespinGameServiceImpl extends BaseRespinGameService implements RespinGameService {
    ...
    public BasePlaySession execute(BasePlaySession basePlaySession, String commandId, UserInfo userInfo,
        ...
        logBuilder
            ...
            .stateName("RespinGameServiceImpl.execute");
        ...
        //step 1: validate
        validationExtension.validateInRespin(basePlaySession, userInfo, commandId);
        //step 2: update playsession
        BasePlaySession.BasePlaySessionBuilder<?,?> builder = playSessionExtension.updatePlaySessionBuilderForRespin(basePlaySession, commandId, userInfo);
        
        //step 3: prepare data for free game before spin
        basePlaySession = subPlaySession.setSubPlaySessionInfoRespin(builder.build(), configMapper);
        ...
        logBuilder.rootCmdId(commandId).stepName("End").owner(LogMessage.OWNER_GAME).message("Passed - Played free spin")
