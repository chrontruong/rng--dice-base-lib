...
public class BaseRtpMiniGameService implements RtpMiniGameService {

    @Autowired
    private MiniGameServiceImpl miniGameServiceImpl; 

    @Autowired
    private ConfigManager configManager;

    public BasePlaySession play(BasePlaySession basePlaySession, String userID, String commandId, int openCell) {
        ...
        UserInfo userInfo = UserInfo.builder()
                ...
                .build();
        BasePlaySession basePlaySessionAfterSpin = miniGameServiceImpl.execute(
                basePlaySession, commandId, userInfo, openCell, configMapper);
        return miniGameServiceImpl.finishPlaySessionRtp(basePlaySessionAfterSpin);
    }
}
