...
//        rtp = rtp.multiply(100.000);
        ...
        SlotMachineConfigForNormal slotMachineConfigNormal = BeanUtils.getBean(SlotMachineConfigForNormal.class);
...
//        rtp = rtp.multiply(100.000);
    ...
    public DenominationLevel toBetPerLineModel(SlotMachineConfigForNormal slotMachineConfig, String idBet, String currency) {
    ...
    public Map<String, Money> initJackPots(SlotMachineConfigForNormal slotMachineConfigNormal, DenominationLevel denominationLevel) {
    ...
    public DenominationLevel initJackPotDemon(SlotMachineConfigForNormal slotMachineConfigNormal, String key) {
        Map<String, Money> jackpotGroup = new HashMap<>();
